    ...
    public static void main(String[] args) {
        ...
        for (;;) {
            ...
            if (decision == "Add") {
                ...
                if (printWhat == "Print everything to a file"){
                    if(lList.isEmpty()){
                ...
                else if (printWhat == "Print everything"){
                    if (lList.isEmpty()){
                        JOptionPane.showMessageDialog(null, "You can't print anything because you currently don't have any items in your list.", "No items", JOptionPane.ERROR_MESSAGE);
                    }
                    else {
                ...
                else if (printWhat == "Print only one item") {
                    if(lList.isEmpty()){
                        JOptionPane.showMessageDialog(null, "You can't print anything because you currently don't have any items in your list.", "No items", JOptionPane.ERROR_MESSAGE);
                    }
                    else {
